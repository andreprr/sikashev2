...
<div class="card w-100 position-relative overflow-hidden">
    <div class="px-4 py-3 border-bottom">
        <h5 class="card-title fw-semibold mb-0 lh-sm">Data Bidang Bisnis</h5>
    </div>
            ...
            <form action="" method="GET">
                <div class="row justify-content-end">
                    <div class="col-4 text-end">
                        <a href="{{ route('businessfield-create') }}" type="button" class="btn btn-primary">Tambah</a>
                    </div>
                    <div class="col-8">
            ...
            <table class="table border customize-table mb-0 align-middle">
                <thead class="text-dark fs-4">
                    <tr>
                        ...
                        <th>
                            <h6 class="fs-4 fw-semibold mb-0">Nama Bidang Bisnis</h6>
                        </th>
                        <th>
                        ...
                        <td>
                            <div class="dropdown dropstart">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('businessfield-edit',['id' => $row->id]) }}"><i class="fs-4 ti ti-edit"></i>Edit</a>
                                    </li>
                                    <form id="form-{{$row->id}}" action="{{route('businessfield-destroy',$row->id)}}" method="POST" onsubmit="return confirm('Apakah anda yakin akan menghapus data {{$row->name}}?');">
